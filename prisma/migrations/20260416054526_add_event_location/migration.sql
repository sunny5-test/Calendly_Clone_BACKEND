...
INSERT INTO "new_event_types" ("color", "created_at", "duration", "id", "kind", "max_invitees", "name", "slug", "updated_at", "user_id") SELECT "color", "created_at", "duration", "id", "kind", "max_invitees", "name", "slug", "updated_at", "user_id" FROM "event_types";
